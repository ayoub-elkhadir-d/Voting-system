 ...
 @isset($data)
        ...
        <form action="/update/{{ $data->id }}" method="POST">
            ...
            <div class="main-grid">
                    ...
                    <div class="section">
                        <h3>Room info</h3>
                        <input type="text" name="room_name" placeholder="Enter Name Room .." class="input-field" value="{{$data->name}}" required>
    ...
    <input type="radio" name="member_type" value="unlimited"
        {{ $data->member_limit == null || $data->member_limit == 0 ? 'checked' : '' }}>
...
<div class="limit-group">
    ...
    <div class="toggle-option {{ $data->visibility == 'private' ? 'active' : '' }}" data-value="private">
        Private
    </div>
    <div class="toggle-option {{ $data->visibility == 'public' ? 'active' : '' }}" data-value="public">
        Public
    </div>
</div>
...
<input type="radio" name="vote_method" value="percentage"
    {{ $data->vote_method == 'percentage' ? 'checked' : '' }}>
    ...
    {{ $data->vote_method == 'scale' ? 'checked' : '' }}>
    ...
    {{ $data->vote_method == 'fibonacci' ? 'checked' : '' }}>
...
<input type="radio" name="vote_method" value="custom"
    {{ $data->vote_method == 'custom' ? 'checked' : '' }}>
                                <span class="checkmark"></span>
                            </label>
    ...
    if (active) {
        document.getElementById('visibilityInput').value = active.dataset.value;
    }
});
    </script>
</body>
