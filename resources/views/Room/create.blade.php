...
<head>
    ...
    <style>
        *{ margin:0; padding:0; box-sizing:border-box; font-family:'Segoe UI',Roboto,sans-serif; }
        ...
        .create-btn{ background:#1a73e8; color:#fff; border:none; padding:16px 70px; font-size:1.1rem; font-weight:800; border-radius:12px; cursor:pointer; transition:0.2s; box-shadow:0 5px 18px rgba(26,115,232,0.25); letter-spacing:0.5px; }
        .create-btn:hover{ background:#1558b0; transform:translateY(-3px); box-shadow:0 8px 24px rgba(26,115,232,0.35); }
        .create-btn:active{ transform:translateY(0); }
        .alert-success{ position:fixed; top:20px; right:20px; display:flex; align-items:center; gap:12px; background:#fff; border-left:4px solid #1a73e8; color:#1a1a2e; padding:14px 20px; border-radius:10px; box-shadow:0 8px 24px rgba(0,0,0,0.12); animation:slideIn 0.4s ease; z-index:9999; }
...
<body>
    ...
    <div class="container">
        ...
        <p class="page-title">Create Room</p>
        ...
        <form action="/createroom" method="POST" id="roomForm">
            ...
            <div class="main-grid">
                <div class="left-col">
                    <div class="section">
                        <h3>Room info</h3>
                        <input type="text" name="room_name" placeholder="Room name..." class="input-field" required>
                    ...
                    <div class="settings-row">
                        <div class="section">
                            ...
                            <div class="limit-group">
                                ...
                                <input type="number" name="member_limit" placeholder="Limit..." class="small-input">
                            </div>
                        </div>
                        ...
                        <div class="voting-options">
                            <label class="voting-card">
                                <div class="card-content">
                                    <span class="icon">%</span>
                                    <div class="card-text"><p class="title">Percentage</p><p class="desc">Vote based on percentage values.</p></div>
                                </div>
                            ...
                            <label class="voting-card">
                                <div class="card-content">
                                    <span class="icon">★</span>
                                    <div class="card-text"><p class="title">Scale 1-10</p><p class="desc">Rate from 1 to 10.</p></div>
                                </div>
                            ...
                            <label class="voting-card">
                                <div class="card-content">
                                    ...
                                    <div class="card-text"><p class="title">Fibonacci</p><p class="desc">1, 2, 3, 5, 8, 13...</p></div>
                                </div>
                            ...
                            <label class="voting-card">
                                <div class="card-content">
                                    <span class="icon">⚙</span>
                                    <div class="card-text"><p class="title">Custom Values</p><p class="desc">Define your own values.</p></div>
                                </div>
